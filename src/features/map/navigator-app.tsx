...
export function NavigatorApp() {
  ...
  return <main className="relative h-dvh overflow-hidden bg-[#e9f1ed] dark:bg-[#12201a]">
    <CampusMap pois={pois} graph={graph} route={route} position={location.position} heading={location.heading} dark={resolvedTheme === "dark"} follow={location.following} hasPmtiles={!!pack.manifest?.files.some((file) => file.id === "pmtiles")} />
